...
@php
        foreach($modelcount as $result) 
        {
                  ...
                  elseif($condition_quantity<=0 and $soon+$condition_quantity > 0)
                                                                    {
                                                                      $status='"badge badge-info">Expected'." ".str_replace( ",", "",$result['eta']);
                                                                      $days_for_del="";
                                                                    }    
                  else
                    {
