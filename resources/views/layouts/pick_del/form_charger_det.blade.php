            ...
            <div class="row">
                  <div class="col-md-12 ml-3 mb-2">
                                        <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" name="chargerpresent" role="switch" id="chargerpresent">
                            ...
                            <div class="row">
                                        <div class="col-md-9 mb-2">
                                            <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" id="chargernbr" name="chargernbr"  placeholder="Ladernummer">
                ...
                <div class="row">
                  <div class="col-md-12 ml-3 mb-2">
                                        <div class="form-check form-switch">
                                                <input class="form-check-input" name="chargertested" type="checkbox" role="switch" id="chargertested">
