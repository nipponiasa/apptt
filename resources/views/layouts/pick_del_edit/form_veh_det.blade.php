                              ...
                              <div class="card-header">
                                ...
                                <div class="card-tools">
                                  ...
                                  <button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times"></i>
                                      ...
                                      <div class="card-body">
                                        ...
                                        <div class="form-group">
                                              ...
                                              <input type="text" class="form-control shadow-lg bg-secondary" onchange="get_vin_det()" id="vin" name="vin" aria-describedby="vinHelp" value="{{$uii->vin}}" placeholder="VIN">
                                        ...
                                        <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" id="model" name="model"  value="{{$uii->model}}" aria-describedby="modelHelp" placeholder="Model">
                                        ...
                                        <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" id="modeldet" style="background-color:#ffa50085;" name="modeldet" value="{{$uii->modeldet}}"  aria-describedby="modeldetHelp" placeholder="">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="vin" aria-describedby="vinHelp" name="licencenbr" value="{{$uii->licencenbr}}" placeholder="Kenteken nmbr.">
                                  ...
                                  <div class="col-md-3 ml-4 mt-4">
                                        <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" role="switch" id="vinplatematch" name="vinplatematch" {{$uii->vinplatematch==1  ? 'checked' : ''}}>
                                    ...
                                    <div class="col-md-9 mb-2">
                                        <div class="form-group">
                                              <label for="notesint">Interne notities {{-- Internal notes --}}</label>
                                                  <textarea id="notesint" name="notesint"  class="form-control" style="background-color:#ffa50085;" aria-describedby="notesintHelp" rows="3">{{$uii->notesint}}</textarea>
