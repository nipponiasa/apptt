                    ...
                    <div class="form-group">
                          ...
                          <select id="dealer" name="dealer" onchange="get_dealers_locations()" class="form-control shadow-lg bg-secondary" aria-describedby="dealerHelp" aria-label="Default select example">
                            ...
                            @foreach($dealers as $dealer)
                                  {
                                    <option value="{{$dealer['id']}}" {{$dealer['id']==$uii->dealer  ? 'selected' : ''}}>{{$dealer['display_name']}}</option>
                                  }
                            @endforeach
                          </select>
                ...
                <div class="row">
                  <div class="col-md-9 mb-2">
                    <div class="form-group">
                          ...
                          <select id="dealerloc" name="dealerloc" onchange="get_dealer_add()" class="form-control shadow-lg bg-secondary" aria-describedby="dealerHelp" >
                            <option selected>Selecteer een locatie..</option>
                            @foreach($locations as $location)
                                  {
                                    <option value="{{$location['id']}}" {{$location['id']==$uii->dealerloc  ? 'selected' : ''}}>{{$location['display_name']}}</option>
                                  }
                            @endforeach
                                    ...
                                    <div class="col-md-9 mb-2">
                                        <div class="form-group">
                                              <label for="address">Adres</label>
                                                  <textarea id="address" name="address" style="background-color:#ffa50085;" class="form-control" aria-describedby="addressHelp" rows="3">{{$uii->address}}</textarea>
                        ...
                        <div class="row">
                                    <div class="col-md-6 mb-3">        
                                              <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="phone" id="phone" aria-describedby="phoneHelp" value="{{$uii->phone}}" placeholder="Phone">
                                    ...
                                    <div class="col-md-6 mb-3">        
                                              <div class="form-group">
                                                    <label for="maila">Emailadres</label>
                                                    <input type="text" class="form-control" name="maila" id="maila" value="{{$uii->maila}}" aria-describedby="mailaHelp" placeholder="Emailadres">
